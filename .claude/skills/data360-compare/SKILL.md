...
description: Compare Data Cloud artifacts — diff CIs side-by-side, compare DMO schemas across orgs (dev vs UAT), or compare CI SQL across similar CIs. Use when user asks to "compare CIs", "diff these CIs", "compare dev and UAT", "org comparison", or "what's different between".
triggers:
  - "compare CIs"
  - "diff these CIs"
  - "compare dev and UAT"
...
Write comparison results to `~/Projects/clients/<Client>/Data360/reports/`. Use descriptive filenames: `ci-comparison-replacement-vs-npi.md`, `org-comparison-dev-uat.md`, etc.
